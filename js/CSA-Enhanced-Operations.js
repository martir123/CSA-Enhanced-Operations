              ...
              // This Adds dynamic links to the the Options column.
              {
                  ...
                  "render": function(data, type, full, meta) {
                      ...
                      /* If its not active then we only show the delete subscription button if the Instance is Canceled and we don't show the Cancel Button*/
                          ...
                          return "<div class='btn-toolbar' role='toolbar'><div class='btn-group' role='group'>" + makeSubLink(full.DT_RowId) + openInst + modifySub + viewTop + ((full.inst_state == "Canceled" || full.inst_state == "Cancelled") ? deleteSub : "") + "</div></div>";
                      }
                  }
              }, {
